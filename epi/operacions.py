...
ACTIVITATS = [
         {'abrProces': 'APE', 'title': 'APE - Gestionar persones: Atenció a persones i equips', 'activitatId': '42909', 'nomProces': 'PROCES_ACT_APE'},
         {'abrProces': 'FOR', 'title': 'FOR - Gestionar persones: Formació', 'activitatId': '42907', 'nomProces': 'PROCES_ACT_FOR'},
         {'abrProces': 'ABC', 'title': 'ABC - Costos ABC', 'activitatId': '100082', 'nomProces': 'PROCES_ACT_ABC'},
         {'abrProces': 'ADM', 'title': 'ADM - Administració', 'activitatId': '42905', 'nomProces': 'PROCES_ACT_ADM'},
         {'abrProces': 'ADS', 'title': 'ADS - Administrar Serveis', 'activitatId': '42894', 'nomProces': 'PROCES_ACT_ADS'},
         {'abrProces': 'APV', 'title': 'APV - APV - Aprovisionar serveis', 'activitatId': '75874', 'nomProces': 'PROCES_ACT_APV'},
         {'abrProces': 'AS TIC 2008', 'title': 'AS TIC 2008 - Coordinació AS TIC 2008', 'activitatId': '43540', 'nomProces': 'PROCES_ACT_QUA'},
         {'abrProces': 'CMI', 'title': 'CMI - Comunicació Interna', 'activitatId': '42910', 'nomProces': 'PROCES_ACT_APE'},
         {'abrProces': 'CMK', 'title': 'CMK - Comunicació i Marketing', 'activitatId': '72834', 'nomProces': 'PROCES_ACT_CMN'},
         {'abrProces': 'CMN', 'title': 'CMN - Comunicació corporativa', 'activitatId': '51132', 'nomProces': 'PROCES_ACT_CMN'},
         {'abrProces': 'CMP', 'title': 'CMP - Gestionar Compres', 'activitatId': '42900', 'nomProces': 'PROCES_ACT_CMP'},
         {'abrProces': 'COM', 'title': 'COM - Comptabilitat', 'activitatId': '100074', 'nomProces': 'PROCES_ACT_COM'},
         {'abrProces': 'DSO', 'title': 'DSO - Dissenyar Solucions', 'activitatId': '42893', 'nomProces': 'PROCES_ACT_DSO'},
         {'abrProces': 'EST', 'title': 'EST - Altres Processos Estratègics', 'activitatId': '42898', 'nomProces': 'PROCES_ACT_EST'},
         {'abrProces': 'FLC', 'title': 'FLC - Facturar a Clients', 'activitatId': '42903', 'nomProces': 'PROCES_ACT_FCL'},
         {'abrProces': 'FNC', 'title': 'FNC - Finances', 'activitatId': '42902', 'nomProces': 'PROCES_ACT_FNC'},
         {'abrProces': 'FPR', 'title': 'FPR - Facturar a Proveïdors', 'activitatId': '42904', 'nomProces': 'PROCES_ACT_FPR'},
         {'abrProces': 'GCO', 'title': 'GCO - Gestionar Cobraments', 'activitatId': '100068', 'nomProces': 'PROCES_ACT_GCO'},
         {'abrProces': 'GEC', 'title': 'GEC - Gestionar els Canvis', 'activitatId': '106258', 'nomProces': 'PROCES_ACT_GEC'},
         {'abrProces': 'GFI', 'title': 'GFI - Gestió Financera', 'activitatId': '100081', 'nomProces': 'PROCES_ACT_GFI'},
         {'abrProces': 'GNS', 'title': 'GNS - GNS - Gestionar nivells de servei', 'activitatId': '75873', 'nomProces': 'PROCES_ACT_GNS'},
         {'abrProces': 'GPA', 'title': 'GPA - Gestionar Pagaments', 'activitatId': '100071', 'nomProces': 'PROCES_ACT_COM'},
         {'abrProces': 'INN', 'title': 'INN - Innovar', 'activitatId': '42897', 'nomProces': 'PROCES_ACT_INN'},
         {'abrProces': 'INN-AEI', 'title': 'INN-AEI - Innovar: Fer anàlisi extern i intern', 'activitatId': '122279', 'nomProces': 'PROCES_ACT_INN'},
         {'abrProces': 'INN-CRE', 'title': 'INN-CRE - Innovar: Fomentar la creativitat', 'activitatId': '122282', 'nomProces': 'PROCES_ACT_INN'},
         {'abrProces': 'INN-PDL', 'title': 'INN-PDL - Innovar: Participar en Premi Davyd Luque', 'activitatId': '149091', 'nomProces': 'PROCES_ACT_INN'},
         {'abrProces': 'INN-PTE', 'title': 'INN-PTE - Innovar: Fer previsió tecnològica', 'activitatId': '122281', 'nomProces': 'PROCES_ACT_INN'},
         {'abrProces': 'INN-VTE', 'title': 'INN-VTE - Innovar: Fer vigilància tecnològica', 'activitatId': '94975', 'nomProces': 'PROCES_ACT_INN'},
         {'abrProces': 'NTF-ADS', 'title': 'NTF-ADS - Notificar Esdeveniments dels Serveis', 'activitatId': '42899', 'nomProces': 'PROCES_ACT_NTFADS'},
         {'abrProces': 'PES', 'title': 'PES - Planificació Estratègica', 'activitatId': '42896', 'nomProces': 'PROCES_ACT_PES'},
         {'abrProces': 'QUA', 'title': 'QUA - Qualitat', 'activitatId': '42895', 'nomProces': 'PROCES_ACT_QUA'},
         {'abrProces': 'RET', 'title': 'RET - Gestionar persones: Retribució', 'activitatId': '42908', 'nomProces': 'PROCES_ACT_RET'},
         {'abrProces': 'SEL', 'title': 'SEL - Gestionar persones: Selecció', 'activitatId': '42906', 'nomProces': 'PROCES_ACT_SEL'},
         {'abrProces': 'SUB', 'title': 'SUB - Subvencions', 'activitatId': '100084', 'nomProces': 'PROCES_ACT_SUB'},
         {'abrProces': 'Suport guardies', 'title': 'Suport guardies - Suport tecnològic a les guardies de serveis cítics', 'activitatId': '113839', 'nomProces': 'PROCES_ACT_ADS'}
         ]
